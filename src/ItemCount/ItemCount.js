...
import soap1 from './soap1.png';
import mascarilla from './mascarilla.jpeg';
 ...
 useEffect(()=>{ //segunda instancia
    ...
    return (
        <div className ="cardsProduct" >
            ...
            <Card.Img variant="top" src={soap1} />
            <Card.Body>
            ...
            <Card.Img variant="top" src={mascarilla} />
            <Card.Body>
                <Card.Title>Producto</Card.Title>
                <Card.Text>
                Lorem ipsum dolor
            ...
            <Card style={{ width: '18rem', height: '100%'}}>
            <Card.Img variant="top" src={serum} />
            <Card.Body>
                <Card.Title>Producto</Card.Title>
                <Card.Text>
                Lorem ipsum dolor
